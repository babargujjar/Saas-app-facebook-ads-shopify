...
const Table = () => {
  ...
  const [data, setData] = useState([
    ...
    },
    {
      ...
      Delivery: "Late",
      "Ad Set Name": "Ad Set B",
      Results: "300",
      Reach: "800",
      "Amount Spent": "100",
      "Cost per Result": "0.33",
      "Purchases Conversion Value": "150",
      "Date Last Edited": "2023-09-02",
      "Ad ID": "AD124",
    },
    {
      Budget: "200",
          ...
          <div className="min-w-max relative">
            <div className="flex font-bold">
              {columnNames.map((name, index) => (
                <div
                  ...
                  style={{
                    ...
                    left:
                      index < 2 ? `${index * columnWidths[name]}px` : "unset",
              ...
              <div
                ...
                {showDropdown && (
                  <div
                    className="absolute top-[100%] left-[-150px] mt-1 w-48 bg-white border rounded-md shadow-lg z-10"
                  >
            ...
            <div className="flex border-t sticky bottom-0 bg-white z-20">
              {columnNames.map((name, index) => (
                <div
                  ...
                  className="border-r p-1 font-bold"
                >
                  {name === "Action" && (
